...
vi.mock('../services/api', () => ({
    ...
    modelsAPI: {
        ...
        preflight: vi.fn().mockResolvedValue({ data: {} }),
        searchHF: vi.fn().mockResolvedValue({ data: { models: [] } }),
        lookupCustom: vi.fn().mockResolvedValue({ data: {} }),
        downloadDirs: vi.fn().mockResolvedValue({ data: { dirs: [] } }),
        download: vi.fn().mockResolvedValue({ data: {} }),
        downloadProgress: vi.fn().mockResolvedValue({ data: {} }),
        cancelDownload: vi.fn().mockResolvedValue({ data: {} }),
        verifyCache: vi.fn().mockResolvedValue({ data: {} }),
    },
    hardwareAPI: {
        status: vi.fn().mockResolvedValue({ data: {} }),
    },
...
// The component lives at components/models/ModelSelector
...
describe('ModelSelector', () => {
    ...
    it('component module can be imported', async () => {
        const mod = await import('../components/models/ModelSelector');
